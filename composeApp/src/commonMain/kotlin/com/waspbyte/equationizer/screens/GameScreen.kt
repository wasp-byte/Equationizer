...
fun GameScreen(
    ...
    viewModel: GameViewModel = viewModel(factory = GameVMFactory(prefs))
) {
...
fun GetGameInput(viewModel: GameViewModel) {
    val gameInput by viewModel.gameInput.collectAsState()
    val puzzle by viewModel.currentEquation.collectAsState()
